const crearNovedad = (titulo, autor, descripcion, url) => {
...
literatura.libros.forEach(libro => {
  const nuevaNovedad = crearNovedad(libro.titulo, libro.autor, libro.descripcion, libro.url);
